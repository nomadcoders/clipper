...
#
# name                       Name shown in the /config picker. Defaults to the file name.
# description                Shown under the name in the /config picker.
# keep-coding-instructions   Keep Claude Code's built-in software engineering
#                            instructions (how to scope changes, write comments,
#                            verify work). Default false — a custom style drops
#                            them unless you set this.
---
