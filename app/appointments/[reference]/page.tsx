    ...
    <main className="relative min-h-screen overflow-hidden bg-canvas text-ink">
      ...
      <div className="mx-auto max-w-6xl px-5 pb-16 sm:px-8 lg:px-12">
        ...
        <div className="relative mx-auto max-w-4xl pt-8 sm:pt-14">
          ...
          <div className="mt-8 flex flex-col gap-4 rounded-2xl border border-line bg-surface px-5 py-5 text-sm text-ink-muted sm:flex-row sm:items-center sm:justify-between sm:px-7">
            <div>
            ...
            <a href="tel:+8225550142" className="inline-flex items-center gap-2 font-bold text-brand hover:text-ink">
