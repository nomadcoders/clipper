    ...
    <main className="min-h-screen overflow-hidden bg-[#f7f9fc] text-[#0a2540]">
      <div className="relative isolate">
        ...
        <header className="mx-auto flex max-w-7xl items-center justify-between px-5 py-6 sm:px-8 lg:px-12">
          ...
          <nav className="flex items-center gap-3 sm:gap-6"><a href="/appointments" className="text-sm font-semibold text-[#0a2540] hover:text-[#635bff]">Appointments</a><a href="#book-prism" className="whitespace-nowrap rounded-full bg-[#635bff] px-4 py-2.5 text-xs font-bold !text-white shadow-[0_6px_18px_rgba(99,91,255,.25)] hover:bg-[#0a2540] sm:px-5 sm:text-sm">Book a visit ›</a></nav>
        </header>
        ...
        <section className="mx-auto grid max-w-7xl items-center gap-10 px-5 pb-16 pt-10 sm:gap-12 sm:px-8 sm:pb-24 sm:pt-16 lg:min-h-[44rem] lg:grid-cols-[1.08fr_0.92fr] lg:px-12 lg:pb-32 lg:pt-24">
          <div className="relative z-10">
            ...
            <div className="mt-7 sm:mt-9"><a href="#book-prism" className="inline-flex rounded-full bg-[#0a2540] px-6 py-3 text-sm font-bold !text-white hover:bg-[#635bff]">Find a time ›</a></div>
          </div>
          <div className="relative flex flex-col gap-5 lg:block lg:min-h-[38rem]">
            <div className="rounded-2xl bg-white/95 p-5 shadow-[0_30px_80px_rgba(50,50,93,.24)] ring-1 ring-[#0a2540]/5 sm:p-6 lg:absolute lg:left-[4%] lg:top-[8%] lg:w-[84%]">
              <div className="flex flex-wrap items-start justify-between gap-3"><div><p className="text-xs font-bold text-[#635bff]">UPCOMING VISIT</p><p className="mt-2 text-xl font-bold tracking-[-0.04em] sm:text-2xl">Luna’s Full Groom</p></div><span className="rounded-full bg-[#e7f8f1] px-3 py-1 text-xs font-bold text-[#08775d]">Confirmed</span></div>
